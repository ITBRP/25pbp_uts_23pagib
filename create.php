...
// insert ke db
$koneksi = new mysqli('localhost', 'root','', 'db_yuni');
$brand = $_POST['brand'];
$model = $_POST['model'];
$year = $_POST['year'];
$price = $_POST['price'];
...
$q = "INSERT INTO uts_yuni(brand, model, year, price, transmission, photo) VALUES ('$brand', '$model', '$year', '$price', '$transmission', " . ($namaPhoto ? "'$namaPhoto'" : "NULL") . ")";
